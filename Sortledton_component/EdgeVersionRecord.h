...
enum EdgeOperation { INSERTION, UPDATE, DELETION };
...
class EdgeVersionRecord {
 public:
  EdgeVersionRecord(dst_t e, version_t* v, char* w, bool has_weight,
                    size_t weight_size);
 ...
 private:
  enum VersionState { SINGLE_VERSION, TWO_VERSIONS, MULTIPLE_VERSIONS };
