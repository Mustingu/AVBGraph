...
vertex_id_t TopologyInterface::logical_id(vertex_id_t id) { return id; }

vertex_id_t TopologyInterface::physical_id(vertex_id_t id) { return id; }

size_t TopologyInterface::neighbourhood_size(vertex_id_t src) {
  return neighbourhood_size_p(physical_id(src));
}

void TopologyInterface::intersect_neighbourhood(vertex_id_t a, vertex_id_t b,
                                                vector<dst_t> &out) {
